...
grader.addManualPart('0a', 4, description="Writeup of 0a")
grader.addManualPart('0b', 4, description="Writeup of 0b")
...
grader.addBasicPart('3a-0', test3a_0, 2, maxSeconds=2, description="Basic test for add_quarter_constraints")
...
grader.addBasicPart('3b-0', test3b_0, 3, maxSeconds=3, description="Basic test for add_unit_constraints")

############################################################
# Problem 3c: Check that profile.txt is valid.
